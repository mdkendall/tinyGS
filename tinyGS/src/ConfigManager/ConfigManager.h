...
private:
  ...
  iotwebconf2::TextParameter mqttServerParam = iotwebconf2::TextParameter ("Server address", "mqtt_server", mqttServer, MQTT_SERVER_LENGTH, NULL, NULL, "type=\"text\" maxlength=30");
  iotwebconf2::NumberParameter mqttPortParam = iotwebconf2::NumberParameter ("Server Port", "mqtt_port", mqttPort, MQTT_PORT_LENGTH, NULL, NULL, "min=\"0\" max=\"65536\" step=\"1\"");
  ...
  iotwebconf2::PasswordParameter mqttPassParam = iotwebconf2::PasswordParameter (NULL, "mqtt_pass", mqttPass, MQTT_PASS_LENGTH, NULL, NULL, "type=\"text\" maxlength=30");
